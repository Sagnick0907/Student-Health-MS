  ...
  <body>
   ...
   <form action="" method="post">       <!--  posting to the same page -->
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="login_admin_username" id="loginemail" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="loginpassword" class="form-label">Password</label>
            <input type="password" class="form-control" name="login_admin_password" id="loginpassword">
        </div>
    ...
    if(isset($_POST["submit"])){
        ...
        $pass=$_POST['login_admin_password'];

        //check whether this email exists or not
        $existsql="select * from `admin` where admin_username='$username'";
        ...
        if($num_rows==1){
            ...
            if(password_verify($pass,$row['password'])){
                ...
                //header("Location:/shms/admin_dashboard.php?loginsuccess=true");
                header("Location:/shms/admin_dashboard.php");
